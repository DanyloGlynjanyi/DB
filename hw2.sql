...
from client
         join department d on idDepartment = client.Department_idDepartment
...
from client
         join department dep on dep.idDepartment = client.Department_idDepartment;
select count(*)
from client
         join department dep2 on dep2.idDepartment = client.Department_idDepartment
where DepartmentCity = 'Lviv';
